...
read -p "Password baru: " -e -i dark DatabasePass
echo ""
...
echo 'echo -e "Script mod by Dark Cry"' >> .bashrc
...
echo "" | tee -a log-install.txt
echo "Auto Script Installer OCS Panels Mod by Dark Cry"  | tee -a log-install.txt
echo "             (######)           "  | tee -a log-install.txt
echo "" | tee -a log-install.txt
